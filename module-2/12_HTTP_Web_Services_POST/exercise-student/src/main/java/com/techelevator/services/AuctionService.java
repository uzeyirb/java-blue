...
public class AuctionService {
    ...
    public Auction update(String auctionString) {
        ...
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<Auction> entity = new HttpEntity<>(auction, headers);
        String apiUrl = API_URL + "/" + auction.getId();
        try{
    ...
    public boolean delete(int id) throws RestClientResponseException, ResourceAccessException {
        ...
        try{
            ...
            console.printError(a.getMessage());
            return false;
        }catch (RestClientResponseException z){
            console.printError(z.getRawStatusCode() + " " + z.getStatusText());
            return false;
        }
        return true;
    }
