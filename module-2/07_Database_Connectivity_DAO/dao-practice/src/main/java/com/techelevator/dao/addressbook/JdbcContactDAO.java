...
public class JdbcContactDAO implements ContactDAO {
    //Create an instance variable for the Jdbc Template
    ...
    public void create(Contact contact) {
        ...
        SqlRowSet rows = jdbcTemplate.queryForRowSet(sql, contact.getFirstName(),
                contact.getLastName(), contact.getDateAdded());
        rows.next();
    ...
    private Contact mapRowToContact(SqlRowSet row) {
        ...
        /*
        because we are calling method on setDataAdded it will throw
        NullPointerException to avoid this add condition      */
