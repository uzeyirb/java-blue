...
@PreAuthorize("hasRole('ADMIN')") // checks for a specific role
...
public class HotelController {
     ...
     */
    /*
    Principal can be added to any method controller method controller method and Spring Boot will pass the method
