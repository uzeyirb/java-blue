...
-- Ok, that gives us a customer_id, but not the name. We can use the customer_id 
-- to get the name FROM the customer table
SELECT *
FROM payment
...
SELECT payment.payment_id, payment.rental_id, customer.first_name, customer.last_name, rental.return_date, film.title, 
...
SELECT first_name, 'A' AS table_name FROM actor
UNION
