...
FROM country 
WHERE gnp > 100000 AND population > 1000000000;
...
SELECT name, lifeexpectancy 
FROM country 
WHERE region LIKE 'Southern%' AND lifeexpectancy IS NOT NULL;
...
FROM country 
WHERE continent IN ('Africa', 'Asia') AND lifeexpectancy >= 70 AND (gnp > 1000 AND gnp < 100000);