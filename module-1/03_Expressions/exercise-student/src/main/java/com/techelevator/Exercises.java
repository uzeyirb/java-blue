...
public class Exercises {
	...
	public int dateFashion(int you, int date) {
		...
		//if you and date more than 8 then 2
		//if you and date less than 2 then 0
		//if you and date else 1
    ...
    public String yourCakeAndEatItToo(double mealAmount, boolean isBirthday) {
    	//if birthday and if 10 then ginormous
		// if birthday and if 5 then special
		//if not birthday and 10 then special
		//if birthday and if 2 then standard
		// if not birthday and less than 5 then standard
		if ((mealAmount > 15 && !isBirthday ) || (mealAmount > 10 && isBirthday) ){
			return "ginormous";
		}

		if ((mealAmount > 10 && !isBirthday) || (mealAmount > 5 && mealAmount < 10 && isBirthday) || (mealAmount >= 10 && isBirthday)) {
			return "special";
		}
	...
	/*
	 ...
	 sortaSum(10, 11) → 21
	 */
	// if sum is between 10 and 20 return 20
	// else return sum
	...
	// if vacation and day >6 ot day == 0 then alarm off
	//else return 7:00
	...
	/*
	 ...
	 teaParty(20, 6) → 2
	 */
	//if tea is double more than candy and candy double more than tea and candy more than 5 and tea more than 5 then great
