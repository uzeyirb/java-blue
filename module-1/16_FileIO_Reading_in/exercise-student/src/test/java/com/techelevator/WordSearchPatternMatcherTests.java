...
public class WordSearchPatternMatcherTests {
    ...
    private static WordSearchPatternMatcher wordSearchPatternMatcher;


    @Before
    public  void setup() {
        wordSearchPatternMatcher = new WordSearchPatternMatcher();
