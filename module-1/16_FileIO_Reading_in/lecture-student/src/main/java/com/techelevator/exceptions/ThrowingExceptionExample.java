...
public class ThrowingExceptionExample {
    ...
    /*
    When a method calls a method with a checked exception. If it does not want to handle the exception
    it can add throws to throw it to the next method in the call stack.
     */
    ...
    /*
    When a methods calls a method with a checked exception. That method
    ...
    /*
    Throws keyword indicates that this method may throw a checked exception
     */
