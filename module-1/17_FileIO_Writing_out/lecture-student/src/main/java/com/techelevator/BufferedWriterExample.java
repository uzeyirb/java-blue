...
public class BufferedWriterExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String pathToNewFile = "C:\\Users\\Student\\source\\repos\\uzeyirbaghirov-java-blue\\module-1\\17_FileIO_Writing_out\\lecture-student\\buffered.txt";
        ...
        try(PrintWriter printWriter = new PrintWriter(fileToWriteTo) ;  BufferedWriter bufferedWriter = new BufferedWriter(printWriter)){
