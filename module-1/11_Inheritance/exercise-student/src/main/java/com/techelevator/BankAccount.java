...
public class BankAccount {
   ...
   */
    ...
    */
    ...
    To override a method, we must provide an identical method signature as the one being overridden.
    Though not required, It also a good practice to include the @Override annotation for readability.
