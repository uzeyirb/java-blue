  ...
  <div class="main">
    ...
    <form v-if="showForm" v-on:submit.prevent="addReview">
      <div class="form-element">
        ...
        <!--In order to bind input attribute to the user input we will use  v-model 
  ...
  data() {
    return {
      ...
      description:
        ...
        // First, In order to bind form to newReview object we need to create newReview object uunder export default
      newReview: {},
      showForm: false,
      filter: 0,
      reviews: [
