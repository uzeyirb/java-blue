...
- At a minimum, ask for the following data (you may add more if you wish):
  ...
  - Favorite color ok
  - Favorite number ok
  - Confirmation that the data is correct ok
- Make name and email address fields required. ok
- Create an HTML form with the necessary attributes. OK
  - Consider the information being sent and what might be the appropriate method.ok
  - You may use a fake URL for the destination of the form submission.ok
  - Consider this: what element is needed to submit the form? ok
- Use the appropriate form elements for the data.Ok
  - Consider the necessary attributes for the form elements.OK
- Use labels for the form elements.OK
- Use CSS to:
  - Set a different background color on the form.OK
  - Add spacing between form inputs.OK
