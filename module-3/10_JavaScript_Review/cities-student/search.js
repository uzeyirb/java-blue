...
document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    showAllButton.addEventListener('click', (eventObj) => {
        showAllCities();
...
function showAllCities() {
    ...
    cities.forEach((city) => {
        addCity(city.name, city.district, city.country, city.population);
...
function showFilterCities() {
    ...
    */
    ...
    // const showAllButton = document.getElementById('showFiltered');
