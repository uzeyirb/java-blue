...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const numbers = Array.from(document.querySelectorAll('.calculator-keys .number '));
  // loop over each of the numbers
  numbers.forEach(number => {
    number.addEventListener('click', (e) =>{   // add a click event listener to each number to call the function clickNumber
      clickNumber(e);
    });
  });
 ...
 // numbers.append(decimal);
  ...
  const operators = Array.from(document.querySelectorAll('.calculator-keys .operator '));
  // loop over each of the operators
  operators.forEach(operator => {

    operator.addEventListener('click', (e) =>{
      clickOperator(e);  // add a click event listener to each operator to call the function clickOperator
    });
  ...
  const equal = document.querySelector('.equal-sign');
   equal.addEventListener('click', (e) =>{  // should call the function performOperation
    performOperation(e);
  });
